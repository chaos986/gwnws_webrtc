...
// Modified by MJHA at Thursday, September 14th, 2016
...
(function () {
    ...
    window.RTCMultiConnection = function (channel) {
        ...
        function joinSession(session, joinAs) {
            ...
            // expectations: if it is one-way streaming; or if it is data-only connection
    ...
    function RTCMultiSession(connection, callbackForSignalingReady) {
        ...
        function newPrivateSocket(_config) {
            ...
            function socketResponse(response) {
                ...
                if (response.failedToReceiveRemoteVideo) {
                    log('Remote peer has not received stream: ' + response.streamid + '. Renegotiating...');
        ...
        this.addStream = function (e) {
            ...
            function addStream(_peer) {
                ...
                if (!socket) {
                    warn(_peer, 'does not have socket.');
                    return;
                }
    ...
    function createMediaElement(stream, session) {
        ...
        isFirefox && mediaElement.addEventListener('inactive', function () {
            stream.onended();
        }, false);
        ...
        return {
            ...
            init: function () {
                ...
                this.connection.onaddstream = function (e) {
                    console.log('rmc onaddstream', isPluginRTC ? e.stream : toStr(e.stream));
            ...
            setConstraints: function () {
                ...
                if (this.constraints) {
                    console.log('sdp-constraints', toStr(this.constraints));
                }
                ...
                console.log('optional-argument', toStr(this.optionalArgument));
            ...
            setRemoteDescription: function (sessionDescription, onSdpSuccess) {
                ...
                this.connection.setRemoteDescription(
                    ...
                    function (error) {
                        if (error.message.search(/STATE_SENTINITIATE|STATE_INPROGRESS/gi) == -1) {
            ...
            addStream: function (stream) {
                ...
                console.log('attaching stream:', stream.streamid, isPluginRTC ? stream : toStr(stream));
    ...
    // Last time updated at Sept 25, 2015, 08:32:23
    ...
    // DetectRTC extender
        ...
        extensionid: 'menhocampcenmmadjchklcalijkbkbmc',
    ...
    function setDefaults(connection) {
        ...
        connection.getExternalIceServers = false; //[[was isChrome mjha 2016-03-18]]
        ...
        connection.onScreenCapturingExtensionAvailable = function () {
            console.log('It seems that screen capturing extension is installed and available on your system!');
        };

        if (!isPluginRTC && connection.onScreenCapturingExtensionAvailable) {
        ...
        connection.onfailed = function (event) {
            ...
            console.error('ICE connectivity check is failed. Renegotiating peer connection.');
        ...
        connection.ondisconnected = function (event) {
            console.error('Peer connection seems has been disconnected between you and', event.userid);
